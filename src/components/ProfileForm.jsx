...
const SOCIAL_FIELDS = [
    ...
    { key: 'whatsapp_business', label: 'WhatsApp Business', placeholder: '+229 XX XX XX XX', icon: '💼', type: 'tel' },
    { key: 'instagram', label: 'Instagram', placeholder: 'https://instagram.com/...', icon: '📸', type: 'url' },
    { key: 'facebook', label: 'Facebook', placeholder: 'https://facebook.com/...', icon: '👥', type: 'url' },
    { key: 'tiktok', label: 'TikTok', placeholder: 'https://tiktok.com/@...', icon: '🎵', type: 'url' },
    { key: 'twitter', label: 'X / Twitter', placeholder: 'https://x.com/...', icon: '🐦', type: 'url' },
    { key: 'linkedin', label: 'LinkedIn', placeholder: 'https://linkedin.com/in/...', icon: '💼', type: 'url' },
    { key: 'snapchat', label: 'Snapchat', placeholder: 'https://snapchat.com/add/...', icon: '👻', type: 'url' },
    { key: 'telegram', label: 'Telegram', placeholder: 'https://t.me/...', icon: '✈️', type: 'url' },
    { key: 'youtube', label: 'YouTube', placeholder: 'https://youtube.com/@...', icon: '▶️', type: 'url' },
    { key: 'pinterest', label: 'Pinterest', placeholder: 'https://pinterest.com/...', icon: '📌', type: 'url' },
    { key: 'github', label: 'GitHub', placeholder: 'https://github.com/...', icon: '💻', type: 'url' },
