...
export default function LandingPage() {
    ...
    return (
        ...
        <div className={`sticky-bar ${showSticky ? 'visible' : ''}`}>
            <button className="sticky-bar-btn" onClick={() => { document.getElementById('tarifs')?.scrollIntoView({ behavior: 'smooth' }); }}>
                Voir les tarifs
            </button>
            <button className="sticky-bar-wa" onClick={() => window.open(getWhatsAppUrl('physique'), '_blank')}>
